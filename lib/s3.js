...
functions.doesObjectExist = async (bucket, key) => {
  ...
  try {
    ...
    console.log(`[/lib/s3.js] [ERROR::ARC_VIDEO_CENTER_INGEST] ${err}`);
    return false;
  }
};
...
functions.getObjectContentsAsJsonString = async (bucket, key) => {
  ...
  try {
    ...
    console.log(`[/lib/s3.js] [ERROR::ARC_VIDEO_CENTER_INGEST] Could not get contents of [${bucket}/${key}]. Error was:\n${err}`);
    return null;
  }
};
